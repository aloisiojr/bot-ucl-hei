...
/*
 * This path is used for webview
 *
 */
app.get('/webview', function(req, res) {
  res.redirect("webview.html");
});
...
function receivedMessage(event) {
  ...
  if (messageText) {
    ...
    switch (messageText.replace(/[^\w\s]/gi, '').trim().toLowerCase()) {
      ...
      case 'fbvideo':
        requiresServerURL(sendFbVideoMessage, [senderID]);
        break;
      ...
      case 'webview':
        requiresServerURL(sendWebView, [senderID]);
        break;
...
//      `
    text: "https://www.facebook.com/esporteinterativo/videos/339555996916338"
    }
  }
 ...
 *
 */
function sendFbVideoMessage(recipientId) {
  var messageData = {
    recipient: {
      id: recipientId
    },
      ...
      attachment: {
        ...
        payload: {
          ...
          elements: [
            {
              media_type: "video",
              //url: "https://www.facebook.com/esporteinterativo/videos/339555996916338",
              //url: "https://www.facebook.com/esporteinterativo/videos/vb.135158248503/428608634569105",
              //url: "https://www.facebook.com/esporteinterativo/videos/2714599061889784/",
              //url: "https://www.facebook.com/100008758598871/videos/1998223390479595/",
              url: "https://www.facebook.com/RuivoGameplays/videos/611802389233530/",
            }
          ]
        }
      }
...
/*
 * Send a button that opens a webview
 *
 */
function sendWebView(recipientId) {
  var messageData = {
    recipient: {
      id: recipientId
    },
    message: {
      attachment: {
        ...
        payload: {
          template_type: "button",
          text: "Welcome. Try the WebView.",
          buttons:[{
            type: "web_url",
            url: SERVER_URL + "/webview",
            title: "WebView with video",
